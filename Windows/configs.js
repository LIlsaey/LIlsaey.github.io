YL.static = {
  /** “关于”信息 */
  softwareName: 'Lilsaey', //网站名。请在此处填写您自己的网站名，如王小明的博客。
  version: "1.0.0", // 网站版本号
  iconBtnStart: 'html5', //主图标
  author: 'lilsaey',//作者
  contactInformation: 'QQ：2810247228',//联系方式
  officialWebsite: 'https://lilsaey.github.io/',//软件官网
  welcome: '本网站UI由 YLUI 强力驱动\n更多信息：//lilsaey.github.io',//加载完毕控制台提示信息
