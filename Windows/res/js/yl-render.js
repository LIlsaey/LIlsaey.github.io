    ...
    methods: {
      ...
      initRuntime: function (first) {
        ...
        if (first && !YL.static.serialNumber) {
          YL.onReady(function () {
            setTimeout(function () {
              YL.msg("lilsaey's Windows", 'Hello，你好，欢迎来到 Windows 小分站！<br/>个人主页：' + '<a style="color: white" target="_blank" href="https://lilsaey.github.io/">https://lilsaey.github.io </a><br />本网站 UI 由 ' + '<a style="color: white" target="_blank" href="https://lilsaey.github.io/"> YLUI </a> 强力驱动<p>使用扫描二维码对作者进行捐赠~<br/><br/><img style="width: 100%" src="https://s1.328888.xyz/2022/05/10/HUrD2.png"/></p>');
            }, 1500)
          });
        }
